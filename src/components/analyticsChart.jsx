...
function AnalyticsChart({ duration, setUniqueVisits }) {
  ...
  useEffect(() => {
    ChartJS.defaults.color = isDarkMode ? "#ffffff" : "#17172A";
  }, [isDarkMode]);
  ...
  }, [svgIcon, isDarkMode]); // Only recompute when svgIcon or dark mode changes
  ...
  useEffect(() => {
    ...
    if (durationQuery) {
      queueMicrotask(() => fetchAnalytics(durationQuery));
    }
  }, [svgIcon, duration, fetchAnalytics]);
