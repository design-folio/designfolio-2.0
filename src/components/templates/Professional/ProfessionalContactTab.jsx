...
function ProfessionalContactTab({ isEditing, socialLinks, onEditContact, allFieldsFilled }) {
  ...
  return (
    <div className="px-4 md:px-6 pb-20 group/section">
      ...
      <div className="max-w-2xl h-full flex items-center justify-center min-h-[128px] mt-4">
          ...
          {socialLinks.map((link, index) => (
            <div key={index} className="relative group">
              <a
                ...
                className="p-5 border border-[#D5D0C6] dark:border-[#3A352E] flex flex-col items-center justify-center gap-3 hover:bg-[#DED9CE]/30 dark:hover:bg-white/[0.02] transition-colors rounded-xl h-32 w-full"
              >
