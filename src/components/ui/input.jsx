...
const Input = forwardRef(function Input({ className, type, ...props }, ref) {
  return (
    <input
      type={type}
      className={cn(
        "text-foreground flex h-10 w-full rounded-xl border border-transparent bg-black/[0.03] px-3.5 py-1 text-sm shadow-none transition-colors dark:bg-white/[0.03] " +
