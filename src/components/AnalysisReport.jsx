...
export default function AnalysisReport({ analysis, onRestart, isRestarting = false }) {
  ...
  return (
    <div className="animate-fadeIn mx-auto w-full max-w-6xl p-8">
      <div className="mb-8 flex justify-end gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 disabled:pointer-events-none disabled:opacity-70"
        >
      ...
      <div id="pdf-content">
        ...
        <div className="mb-8 text-center">
          <h1 className="mb-6 text-3xl font-bold text-gray-900">Salary Analysis Report</h1>
        ...
        <div className="prose prose-green max-w-none">
          <ReactMarkdown
            components={{
              h1: ({ children }) => (
                <h2 className="mb-4 border-b pb-2 text-2xl font-bold text-gray-900">{children}</h2>
              ),
              h2: ({ children }) => (
