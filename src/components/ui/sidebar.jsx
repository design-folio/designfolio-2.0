  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            // h-svh removed — FloatingPageContainer's transform clips it. Restore if that container is removed.
            "fixed inset-y-0 z-50 hidden w-(--sidebar-width) transition-[left,right] duration-200 ease-linear md:flex",
            side === "left"
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "custom-thin-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
