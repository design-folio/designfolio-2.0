...
export function SalaryNegotiationIcon({ className = "" }) {
  return (
    <svg
      width="40"
      height="40"
      ...
      className={className}
    >
      <g clipPath="url(#clip0_salary_negotiation)">
        <path d="M32 28.95H30.47V30.48H32V28.95Z" fill="currentColor" />
        <path
          d="M30.47 1.52H28.95V3.05H27.43V4.57H28.95V6.1H30.47V4.57H32V3.05H30.47V1.52Z"
          fill="currentColor"
        />
        ...
        <path
          d="M24.38 32V30.48H25.9V28.95H24.38V27.43H22.85V28.95H21.33V30.48H22.85V32H24.38Z"
          fill="currentColor"
        />
        ...
        <path
          d="M18.28 22.86H16.76V27.43H18.28V25.91H19.81V24.38H18.28V22.86Z"
          fill="currentColor"
        />
        <path d="M18.28 0H16.76V1.52H18.28V0Z" fill="currentColor" />
        <path d="M16.76 27.43H13.71V28.95H16.76V27.43Z" fill="currentColor" />
        <path
          d="M13.71 22.86H12.19V24.38H10.66V25.91H12.19V27.43H13.71V22.86Z"
          fill="currentColor"
        />
        ...
        <path
          d="M10.66 6.10001V7.62001H12.19V6.10001H18.28V7.62001H19.81V6.10001H24.38V4.57001H6.09V6.10001H10.66Z"
          fill="currentColor"
        />
        ...
        <path
          d="M1.52 13.71H6.09V15.24H7.62V13.71H22.85V15.24H24.38V13.71H28.95V15.24H30.47V10.67H28.95V12.19H24.38V10.67H22.85V12.19H7.62V10.67H6.09V12.19H1.52V10.67H0V15.24H1.52V13.71Z"
          fill="currentColor"
        />
        <path d="M3.04 9.14H1.52V10.67H3.04V9.14Z" fill="currentColor" />
        <path
          d="M1.52 4.57H3.04V3.05H4.57V1.52H3.04V0H1.52V1.52H0V3.05H1.52V4.57Z"
          fill="currentColor"
        />
        <path d="M1.52 24.38H0V25.91H1.52V24.38Z" fill="currentColor" />
      </g>
      <defs>
        <clipPath id="clip0_salary_negotiation">
