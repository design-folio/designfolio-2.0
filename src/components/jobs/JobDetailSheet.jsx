...
const MD_COMPONENTS = {
  p: ({ children }) => (
    <p className="text-sm text-foreground/75 leading-[1.7] mb-3 last:mb-0">{children}</p>
  ),
  ul: ({ children }) => (
  ...
  h3: ({ children }) => (
    <h3 className="text-sm font-semibold text-foreground/70 mt-4 mb-1.5">{children}</h3>
  ),
  h2: ({ children }) => (
    <h2 className="text-sm font-semibold text-foreground/75 mt-4 mb-2">{children}</h2>
  ),
  h1: ({ children }) => (
    <h1 className="text-base font-semibold text-foreground/80 mt-4 mb-2">{children}</h1>
  ),
};
...
function ComingSoonBadge() {
  return (
    <span className="relative flex items-center gap-0.5 bg-violet-50 dark:bg-violet-500/10 border border-violet-200/60 dark:border-violet-400/20 rounded-full px-1.5 py-0.5 shrink-0 overflow-hidden cursor-not-allowed">
      ...
      <span className="text-[9.5px] font-semibold text-violet-500 dark:text-violet-400 tracking-tight relative z-10 cursor-not-allowed">
        Soon
      </span>
    </span>
  );
          ...
          <>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 cursor-pointer">
                        <div className="flex items-center gap-2 cursor-pointer">
                          <span className="text-[13px] font-semibold text-foreground/80 group-hover:text-foreground transition-colors leading-none cursor-pointer">
                            Practice with a mock interview
                          </span>
                          <span className="text-[9.5px] font-medium text-foreground/35 leading-none whitespace-nowrap cursor-pointer">
                            ✦ Recommended
                          </span>
                        </div>
                        <div className="text-[11px] text-foreground/40 mt-1 leading-snug cursor-pointer">
              ...
              {displayJob.description && (
                <div className="px-5 py-5 border-b border-black/[0.06] dark:border-white/[0.06]">
                  <h3 className="text-sm font-semibold text-foreground opacity-70 uppercase tracking-widest mb-3">
                    About the role
                  </h3>
                          ...
                          >
                            <div className="flex items-center gap-3 min-w-0">
                              ...
                              <div className="min-w-0">
                                <div className="text-[13px] font-medium text-foreground/75 leading-none">
