          ...
          <>
            ...
            {isEditing && (
              <div className="flex flex-col gap-4">
                <div className="rounded-2xl aspect-[3/2] border border-dashed border-black/15 dark:border-white/10 bg-black/[0.015] dark:bg-white/[0.015] flex flex-col items-center justify-center gap-3 transition-colors hover:bg-black/[0.03] dark:hover:bg-white/[0.03]">
