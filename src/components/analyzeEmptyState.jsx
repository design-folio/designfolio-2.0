...
export default function AnalyzeEmptyState() {
  return (
    <div className="flex flex-col items-start justify-center gap-6">
      ...
      <div>
        <h3 className="text-base font-semibold text-foreground">Analyze your case study</h3>
        <p className="text-sm text-muted-foreground mt-1">Start by adding text to the editor</p>
      </div>
