...
function CanvasSkillsMarquee({ skills = [], isEditing }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-white/80 dark:from-[#2A2520]/80 to-transparent z-10 rounded-l-[24px]"></div>
      <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-white/80 dark:from-[#2A2520]/80 to-transparent z-10 rounded-r-[24px]"></div>
