...
export function MockInterviewIcon({ className = "" }) {
  return (
    <svg
      width="40"
      height="40"
    ...
    >
      <path
        d="M30.48 28.96H24.38V25.91H27.43V24.38H24.38V22.86H25.91V21.34H24.38V18.29H27.43V16.77H24.38V15.24H22.86V16.77H19.81V18.29H22.86V21.34H21.33V22.86H22.86V24.38H19.81V25.91H22.86V28.96H9.14V25.91H12.19V24.38H9.14V22.86H10.67V21.34H9.14V18.29H12.19V16.77H9.14V15.24H10.67V13.72H9.14V10.67H7.62V13.72H6.1V15.24H7.62V16.77H4.57V18.29H7.62V21.34H6.1V22.86H7.62V24.38H4.57V25.91H7.62V28.96H1.52V30.48H0V32H32V30.48H30.48V28.96Z"
        fill="currentColor"
      />
