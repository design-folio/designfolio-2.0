  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          By accessing and using Designfolio, you accept and agree to be bound by the terms and
      ...
      <section>
        ...
        <p>
          You retain all ownership rights to the content you upload to Designfolio. By uploading
          content, you grant us a license to store, display, and distribute your content as
          necessary to provide our services. We do not claim ownership of your portfolio content.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Designfolio and its affiliates will not be liable for any indirect, incidental, special,
          consequential, or punitive damages resulting from your use or inability to use the
          service. We provide the service &quot;as is&quot; without warranties of any kind.
        </p>
      </section>
