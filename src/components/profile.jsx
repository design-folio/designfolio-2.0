...
export default function Profile({
  ...
  return (
    ...
    >
      <Card
        className={cn("bg-df-section-card-bg-color backdrop-blur-sm border-0 rounded-[24px] overflow-hidden relative", userDetails?.wallpaper && userDetails?.wallpaper?.value != 0 && "bg-white/95 dark:bg-[#1d1f27]/95  backdrop-blur-sm")}
        style={{
          boxShadow:
