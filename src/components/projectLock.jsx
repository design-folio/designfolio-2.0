...
export default function ProjectLock() {
  ...
  return (
    <div className="w-full h-full rounded-2xl flex flex-col items-center justify-center p-10 min-h-[400px] gap-4 relative bg-background border border-border shadow-sm">
