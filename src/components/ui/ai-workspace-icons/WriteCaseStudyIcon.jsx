...
export function WriteCaseStudyIcon({ className = "" }) {
  return (
    <svg
      width="40"
      height="40"
    ...
    >
      <path
        d="M27.4351 3.05H28.9551V1.52H30.4751V0H21.3351V1.52H27.4351V3.05Z"
        fill="currentColor"
      />
      ...
      <path
        d="M3.05502 32H16.765V30.48H18.285V24.38H16.765V25.91H9.14502V24.38H6.10002V22.86H3.05502V24.38H1.52502V30.48H3.05502V32ZM4.57502 25.91H6.10002V28.95H9.15002V30.48H6.10002V28.95H4.57502V25.91Z"
        fill="currentColor"
      />
      ...
      <path
        d="M16.765 13.72H13.715V12.19H12.195V10.67H10.675V15.24H16.765V13.72Z"
        fill="currentColor"
      />
      ...
      <path
        d="M7.62507 19.81H12.1951V22.86H13.7151V19.81H15.2451V18.29H10.6751V15.24H9.14507V18.29H4.57507V19.81H6.09507V22.86H7.62507V19.81Z"
        fill="currentColor"
      />
    </svg>
  );
