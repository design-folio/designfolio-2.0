...
export function CourseCard() {
  ...
  return (
    <>
      <div
        className={`fixed bottom-0 z-50 w-[calc(100%-2rem)] md:w-[300px] bg-white dark:bg-[#23252F] border border-border rounded-t-2xl shadow-[0_-8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgb(0,0,0,0.3)] transition-all duration-500 [transition-timing-function:cubic-bezier(0.23,1,0.32,1)] transform ${
      ...
      >
        ...
        {/* Content Area */}
        <div
          className={`p-6 space-y-8 overflow-y-auto max-h-[80vh] transition-opacity duration-300 ${
        ...
        >
          ...
          <div className="space-y-2 pt-1">
            ...
            <p className="text-[12px] font-medium text-foreground">24 of 30 seats remaining</p>
          </div>
